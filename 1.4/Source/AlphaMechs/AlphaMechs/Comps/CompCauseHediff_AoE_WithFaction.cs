...
{
	public class CompCauseHediff_AoE_WithFaction : ThingComp
	{
		private Sustainer activeSustainer;

		private bool lastIntervalActive;

		private CompProperties_CauseHediff_AoE_WithFaction Props => (CompProperties_CauseHediff_AoE_WithFaction)props;
